...
exports.normalizeRoborockRoomDisplayName = normalizeRoborockRoomDisplayName;
const ROBOROCK_ROOM_TYPE_TOKENS = {
...
function localizeRoborockRoomTypeToken(roomName, getDefaultRoomName, translate) {
...
function localizeRoborockRoomTypeId(roomTypeId, getDefaultRoomName, translate) {
    if (typeof roomTypeId !== "number" || !Number.isFinite(roomTypeId))
        return undefined;
...
function normalizeRoborockRoomDisplayName(roomName, getDefaultRoomName, translate, roomTypeId) {
...
//# sourceMappingURL=roomNameNormalizer.js.map