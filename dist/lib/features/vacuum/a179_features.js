...
const a179Config = {
    staticFeatures: [
        ...
        features_enum_1.Feature.GetPhoto
    ]
};
const Z70_ARM_DIRECTION_STATES = {
    1: "Up",
    2: "Down",
    3: "Go",
    4: "Back"
};
const Z70_ARM_MOVE_PRESET_STATES = {
    "[2,0,0]": "M3 Left",
    "[1,0,0]": "M3 Right",
    "[0,1,0]": "M4 Left",
    "[0,2,0]": "M4 Right",
...
const Z70_GRAB_MODE_STATES = {
    0: "Exit / Off",
    1: "Manual Mode",
    2: "Auto Mode"
};
const Z70_PICK_UP_STATES = {
    0: "Auto Grab",
    1: "Manual Grab"
};
const Z70_PUT_DOWN_STATES = {
    0: "Put Down"
};
const Z70_CAMERA_STATES = {
    0: "Disable Mechanical Camera",
    1: "Enable Mechanical Camera"
};
const Z70_VIDEO_QUALITY_STATES = {
    SD: "SD",
    HD: "HD",
    FHD: "FHD",
    AUTO: "AUTO"
};
const Z70_ROLLER_MOP_STATES = {
    0: "In",
    1: "Out"
};
const Z70_ROLLER_MOP_COVER_STATES = {
    0: "Stretch Out",
    1: "Retract"
};
const Z70_LDS_LIFTING_STATES = {
    0: "Lower",
    1: "Lift Up"
};
const Z70_EXHIBITION_MODE_STATES = {
    0: "Exit",
    1: "Enter"
};
const Z70_SMART_WASH_STATES = {
    0: "Custom / Timed",
    1: "Smart",
    2: "New Smart"
};
const Z70_BACK_WASH_MODE_STATES = {
    0: "Smart",
    1: "Custom",
    2: "New Smart"
};
const Z70_WASH_TOWEL_MODE_STATES = {
...
const Z70_WASH_TEMPERATURE_STATES = {
    0: "Normal",
    1: "Warm",
    2: "Hot / High Temperature"
};
const Z70_BACK_TYPE_LABELS = {
    1: "Washing Mop",
    2: "Setting Up Mop",
    3: "Removing Mop",
    4: "Collecting Dust"
};
const Z70_WASH_PHASE_LABELS = {
    11: "Running",
    17: "Pumping"
};
const Z70_WASHING_MODE_LABELS = {
    6: "Dock Self-Cleaning",
    7: "Water Draining",
    11: "Pumping Water"
};
const Z70_BINARY_STATUS_STATES = {
    0: "Off",
    1: "On"
};
const Z70_PROGRAM_RUNTIME_RESULT_STATES = {
...
const Z70_PROGRAM_STATE_STATES = {
    0: "Without Tasks",
    1: "Starting",
    2: "Executing",
    3: "Error"
};
const Z70_PROGRAM_TYPE_STATES = {
    1: "My Program",
    2: "Official Recommendation"
};
const Z70_PROGRAM_ARM_DIRECTION_LABELS = {
    1: "Arm Position Up",
    2: "Arm Position Down",
    3: "Arm Position Head",
    4: "Arm Position Back"
};
const Z70_PROGRAM_COMMAND_LABELS = {
    arm_out: "Arm Out",
    arm_grasp: "Auto Grab",
...
const Z70_PROGRAM_ARM_MOVE_AXES = ["M3", "M4", "M5", "M6"];
const Z70_EASTER_EGG_TYPE_STATES = {
    0: "Dance"
};
...
let A179Features = class A179Features extends v1VacuumFeatures_1.V1VacuumFeatures {
    z70FirmwareFeatures;
    z70HomeSecStatus = null;
    z70HomeSecClientId = null;
    z70RobotState = null;
    z70LockStatus = null;
    z70IsLocating = false;
    z70VoiceChatActive = false;
    z70DryStatus = null;
    z70ExitDock = null;
    z70WashPhase = null;
    z70SwitchStatus = null;
    z70CleanFluidStatus = null;
    z70QueryOnlyCommandIds = new Set([
        "get_camera_status",
    ...
    z70SettingsOnlyCommandIds = new Set([
        "set_camera_status",
    ...
    z70EmptyArrayCommandIds = new Set([
        "app_stop_grasp",
    ...
    z70NoParamArrayCommandIds = new Set([
        "get_camera_status",
        "get_wash_debug_params",
        "get_clean_roller_debug_info",
        "app_get_dryer_setting",
    ...
    z70CmdCommandIds = new Set([
        "app_rc_roller_mop_cover",
        "app_rc_roller_mop"
    ]);
    z70FlagCommandIds = new Set([
    ...
    z70StartTimeCommandIds = new Set([
        "app_tidy_up_record_detail",
    ...
    reclassifyZ70WritableCommandGroups() {
    ...
    async cleanupLegacyZ70CommandStates() {
        const movedCommands = [
    ...
    async getCommandParams(method, params, id) {
        ...
        if (method === "app_set_door_sill_blocks"
        ...
        if (method === "app_get_segment_clean_subdivision"
        ...
        if (method === "app_start_replenish_clean_area"
        ...
        if (method === "app_set_cross_carpet_cleaning_status"
    ...
    async onCommandResult(requestedMethod, finalMethod, response, params) {
        ...
        switch (finalMethod) {
            ...
            case "get_child_lock_status":
                await this.applyGroupedBinaryResultStatePayload(response, "deviceStatus", "childLock", "Child Lock", "lock_status", "childLockStatus", "Child Lock Status", "childLockEnabled", "Child Lock Enabled");
                return;
            case "get_collision_avoid_status":
                await this.applyGroupedBinaryResultStatePayload(response, "deviceStatus", "collisionAvoid", "Collision Avoid", "status", "collisionAvoidStatus", "Collision Avoid Status", "collisionAvoidEnabled", "Collision Avoid Enabled");
                return;
            case "get_flow_led_status":
                await this.applyGroupedBinaryResultStatePayload(response, "deviceStatus", "flowLed", "Flow LED", "status", "flowLedStatus", "Flow LED Status", "flowLedEnabled", "Flow LED Enabled");
                return;
            case "get_map_beautification_status":
                await this.applyGroupedBinaryResultStatePayload(response, "cleaningInfo", "mapBeautification", "Map Beautification", "status", "mapBeautificationStatus", "Map Beautification Status", "mapBeautificationEnabled", "Map Beautification Enabled");
                return;
            case "test_get_enable_wakeup":
                await this.applyGroupedBinaryResultStatePayload(response, "homeSecurity", "voiceWakeup", "Voice Wakeup", "enable_wakeup", "voiceWakeupStatus", "Voice Wakeup Status", "voiceWakeupEnabled", "Voice Wakeup Enabled");
                return;
            ...
            case "get_auto_delivery_cleaning_fluid":
                await this.applyGroupedBinaryResultStatePayload(response, "dockingStationStatus", "autoDeliveryCleanFluid", "Auto Delivery Clean Fluid", "status", "autoDeliveryCleanFluidStatus", "Auto Delivery Clean Fluid Status", "autoDeliveryCleanFluidEnabled", "Auto Delivery Clean Fluid Enabled");
                return;
            case "get_ap_mic_led_status":
                await this.applyGroupedBinaryResultStatePayload(response, "homeSecurity", "voiceControlLed", "Voice Control LED", "status", "voiceControlLedStatus", "Voice Control LED Status", "voiceControlLedEnabled", "Voice Control LED Enabled");
                return;
            case "get_voice_service_switch":
                await this.applyGroupedBinaryResultStatePayload(response, "homeSecurity", "voiceService", "Voice Service", "data", "voiceServiceData", "Voice Service Data", "voiceServiceEnabled", "Voice Service Enabled");
                return;
            case "get_handle_leak_water_status":
                await this.applyGroupedBinaryResultStatePayload(response, "dockingStationStatus", "waterLeak", "Water Leak", "status", "waterLeakStatus", "Water Leak Status", "waterLeakEnabled", "Water Leak Enabled");
                return;
    ...
    async refreshTidyUpSummaryStatus() {
        try {
            const response = await this.deps.adapter.requestsHandler.sendRequest(this.duid, "app_tidy_up_record_summary", {});
            await this.applyTidyUpSummaryStatus(response);
        }
        catch (e) {
            this.deps.adapter.rLog("System", this.duid, "Warn", this.protocolVersion || undefined, undefined, `Failed to update Tidy-Up Summary: ${this.deps.adapter.errorMessage(e)}`, "warn");
        }
    }
    async refreshZ70Zones() {
        ...
        try {
            ...
            this.deps.adapter.rLog("System", this.duid, "Warn", this.protocolVersion || undefined, undefined, `Failed to update Tidy-Up Zones: ${this.deps.adapter.errorMessage(e)}`, "warn");
        }
    }
    async refreshProgramSummaryStatus() {
        try {
            const response = await this.deps.adapter.requestsHandler.sendRequest(this.duid, "app_get_programs_summary", {});
            await this.applyProgramSummaryStatus(response);
        }
        catch (e) {
            this.deps.adapter.rLog("System", this.duid, "Warn", this.protocolVersion || undefined, undefined, `Failed to update Program Summary: ${this.deps.adapter.errorMessage(e)}`, "warn");
        }
    }
    async refreshProgramDetailStatus(entries) {
        ...
        const details = await Promise.all(programEntries.map(async ({ entry, programId }) => {
            try {
                ...
                this.deps.adapter.rLog("System", this.duid, "Warn", this.protocolVersion || undefined, undefined, `Failed to update Program Detail ${programId}: ${this.deps.adapter.errorMessage(e)}`, "warn");
    ...
    async applyProgramSummaryStatus(rawValue) {
    ...
    async refreshProgramRuntimeStatus() {
        try {
            const response = await this.deps.adapter.requestsHandler.sendRequest(this.duid, "app_get_program_runtime", {});
            await this.applyProgramRuntimeStatus(response);
        }
        catch (e) {
            this.deps.adapter.rLog("System", this.duid, "Warn", this.protocolVersion || undefined, undefined, `Failed to update Program Runtime: ${this.deps.adapter.errorMessage(e)}`, "warn");
        }
    }
    async applyProgramRuntimeStatus(rawValue) {
        const normalized = this.normalizeCommandPayload(rawValue);
        ...
        const commands = this.normalizeProgramRuntimeCommands(normalized.result);
    ...
    async refreshProgramSoundListStatus() {
        try {
            const response = await this.deps.adapter.requestsHandler.sendRequest(this.duid, "app_get_program_soundlist", {});
            await this.applyProgramSoundListStatus(response);
        }
        catch (e) {
            this.deps.adapter.rLog("System", this.duid, "Warn", this.protocolVersion || undefined, undefined, `Failed to update Program Sound List: ${this.deps.adapter.errorMessage(e)}`, "warn");
        }
    }
    async applyProgramSoundListStatus(rawValue) {
    ...
    async applyRobotSettingStatus(rawValue) {
        const normalized = this.normalizeRpcPayload(rawValue);
    ...
    async applyCleanEstimateStatus(rawValue) {
        const normalized = this.normalizeRpcPayload(rawValue);
        ...
        const cleanTimeSeconds = Number(normalized.clean_time);
        ...
        const cleanArea = Number(normalized.clean_area);
    ...
    async applyCarpetDeepCleanStatus(rawValue) {
        const normalized = this.normalizeRpcPayload(rawValue);
    ...
    async applyDryerSettingStatus(rawValue) {
        const normalized = this.normalizeRpcPayload(rawValue);
        ...
        const dryTimeSeconds = Number(normalized.on?.dry_time);
    ...
    async applyWifiListStatus(rawValue) {
        const normalized = this.normalizeRpcPayload(rawValue);
    ...
    async applyCompactArrayStatus(rawValue, relativePathBase, label) {
        const normalized = this.normalizeRpcPayload(rawValue);
    ...
    async applyCompactJsonStatus(rawValue, relativePath, label) {
        const normalized = this.normalizeCommandPayload(rawValue);
        await this.cleanupLegacyPaths([relativePath.replace(/JSON$/, "")]);
        await this.writeJsonState(relativePath, label, normalized);
    }
    async refreshDockInfoStatus() {
        try {
            const response = await this.deps.adapter.requestsHandler.sendRequest(this.duid, "get_dock_info", {});
            await this.applyDockInfoStatus(response);
        }
        catch (e) {
            this.deps.adapter.rLog("System", this.duid, "Warn", this.protocolVersion || undefined, undefined, `Failed to update Dock Info: ${this.deps.adapter.errorMessage(e)}`, "warn");
        }
    }
    async applyDockInfoStatus(rawValue) {
        const normalized = this.normalizeCommandPayload(rawValue);
    ...
    async refreshMapBeautificationStatus() {
        await this.refreshBinaryResultState("get_map_beautification_status", [], "cleaningInfo", "mapBeautification", "Map Beautification", "status", "mapBeautificationStatus", "Map Beautification Status", "mapBeautificationEnabled", "Map Beautification Enabled");
    }
    async applyVoiceKeepSecondsStatus(rawValue) {
        const normalized = this.normalizeCommandPayload(rawValue);
    ...
    async applyVoiceHistoryStatus(rawValue) {
        const normalized = this.normalizeCommandPayload(rawValue);
    ...
    async refreshHomeSecConnectStatus() {
        try {
            const response = await this.deps.adapter.requestsHandler.sendRequest(this.duid, "get_homesec_connect_status", []);
            await this.applyHomeSecConnectStatus(response);
        }
        catch (e) {
            this.deps.adapter.rLog("System", this.duid, "Warn", this.protocolVersion || undefined, undefined, `Failed to update Home Security Connect: ${this.deps.adapter.errorMessage(e)}`, "warn");
        }
    }
    async applyHomeSecConnectStatus(rawValue) {
        const normalized = this.normalizeCommandPayload(rawValue);
        ...
        const clientId = typeof normalized.client_id === "string"
            ? String(normalized.client_id).trim()
            : "";
        this.z70HomeSecClientId = clientId || null;
        await this.refreshDerivedHomeSecPreviewState();
    }
    async refreshAutoDeliveryCleanFluidStatus() {
        await this.refreshBinaryResultState("get_auto_delivery_cleaning_fluid", {}, "dockingStationStatus", "autoDeliveryCleanFluid", "Auto Delivery Clean Fluid", "status", "autoDeliveryCleanFluidStatus", "Auto Delivery Clean Fluid Status", "autoDeliveryCleanFluidEnabled", "Auto Delivery Clean Fluid Enabled");
    }
    async refreshVoiceControlLedStatus() {
        await this.refreshBinaryResultState("get_ap_mic_led_status", {}, "homeSecurity", "voiceControlLed", "Voice Control LED", "status", "voiceControlLedStatus", "Voice Control LED Status", "voiceControlLedEnabled", "Voice Control LED Enabled");
    }
    async refreshVoiceServiceSwitchStatus() {
        await this.refreshBinaryResultState("get_voice_service_switch", [], "homeSecurity", "voiceService", "Voice Service", "data", "voiceServiceData", "Voice Service Data", "voiceServiceEnabled", "Voice Service Enabled");
    }
    async refreshWaterLeakStatus() {
        await this.refreshBinaryResultState("get_handle_leak_water_status", {}, "dockingStationStatus", "waterLeak", "Water Leak", "status", "waterLeakStatus", "Water Leak Status", "waterLeakEnabled", "Water Leak Enabled");
    }
    async readTidyZonesFromMapState() {
        try {
            ...
            this.deps.adapter.rLog("System", this.duid, "Debug", this.protocolVersion || undefined, undefined, `Failed to read Tidy-Up Zones from map data: ${this.deps.adapter.errorMessage(e)}`, "debug");
            return null;
        }
    }
    normalizeTidyZones(value) {
        if (!Array.isArray(value)) {
            return [];
        }
        return value.map((zone) => this.normalizeTidyZone(zone));
    }
    normalizeTidyZone(zone) {
    ...
    async writeExperimentalPayload(folder, label, payload, options = false) {
    ...
    async pruneExperimentalPayloadStates(folder, stateKeys) {
    ...
    async cleanupLegacyPaths(relativePaths) {
        if (typeof this.deps.adapter.delObjectAsync !== "function") {
            return;
        }
    ...
    async writeJsonState(relativePath, name, payload) {
    ...
    normalizeNumericParam(params, method) {
    ...
    normalizeBackWashModeParam(params, method) {
    ...
    normalizeBackWashIntervalMinutes(params, method) {
    ...
    normalizeArmMoveParam(params, method) {
    ...
    normalizeBinarySwitchParam(params, method) {
        const rawValue = Array.isArray(params) && params.length === 1 ? params[0] : params;
    ...
    normalizeBooleanParam(params, method) {
        const rawValue = Array.isArray(params) && params.length === 1 ? params[0] : params;
        if (typeof rawValue === "boolean") {
            return rawValue;
        }
    ...
    normalizeOptionalBooleanSwitch(value, label) {
    ...
    normalizeTextParam(params, method) {
        const rawValue = Array.isArray(params) && params.length === 1 ? params[0] : params;
    ...
    normalizeVideoQualityParam(params, method) {
    ...
    normalizeProgramNameAndIdParam(params, method) {
    ...
    async normalizeStartProgramParam(params, method) {
        const rawValue = Array.isArray(params) && params.length === 1 ? params[0] : params;
    ...
    normalizePatrolParam(params, method) {
        const payload = this.normalizeRequiredObjectParam(params, method);
    ...
    normalizeOptionalObjectParam(params, method) {
        const rawValue = Array.isArray(params) && params.length === 1 ? params[0] : params;
    ...
    async normalizeCameraPreviewParams(params, method) {
    ...
    normalizeRequiredObjectParam(params, method) {
        const payload = this.parseJsonParam(params, method);
        if (typeof payload !== "object" || payload === null || Array.isArray(payload)) {
            throw new Error(`${method} expects an object payload`);
        }
    ...
    normalizeExhibitionActionParam(params, method) {
        const payload = this.parseJsonParam(params, method);
        if (typeof payload !== "object" || payload === null || Array.isArray(payload)) {
    ...
    normalizeHomeSecPasswordParam(params, method) {
        const payload = this.normalizeRequiredObjectParam(params, method);
    ...
    normalizeRobotSettingQueryParam(params, method) {
        const rawValue = Array.isArray(params) && params.length === 1 ? params[0] : params;
        if (typeof rawValue === "string") {
            const trimmed = rawValue.trim();
            if (!trimmed) {
        ...
        if (Array.isArray(payload)) {
            return payload.map((entry, index) => {
                ...
                if (typeof entry === "object" && entry !== null && !Array.isArray(entry) && typeof entry.name === "string" && String(entry.name).trim()) {
    ...
    async refreshSmartWashStatus() {
        try {
            ...
            this.deps.adapter.rLog("System", this.duid, "Warn", this.protocolVersion || undefined, undefined, `Failed to update Smart Wash: ${this.deps.adapter.errorMessage(e)}`, "warn");
        }
    }
    async applySmartWashStatus(rawValue, firmwareFeatures) {
        const normalized = this.normalizeCommandPayload(rawValue);
        ...
        const smartWashValue = Number(normalized.smart_wash);
        const washIntervalSeconds = Number(normalized.wash_interval);
    ...
    async applyWashTowelSupportStates(firmwareFeatures) {
    ...
    async refreshWashTowelParams() {
        try {
            const response = await this.deps.adapter.requestsHandler.sendRequest(this.duid, "get_wash_towel_params", []);
            await this.applyWashTowelParamsStatus(response);
        }
        catch (e) {
            this.deps.adapter.rLog("System", this.duid, "Warn", this.protocolVersion || undefined, undefined, `Failed to update Wash Towel Params: ${this.deps.adapter.errorMessage(e)}`, "warn");
        }
    }
    async applyWashTowelParamsStatus(rawValue) {
        const normalized = this.normalizeCommandPayload(rawValue);
        await this.writeJsonState("dockingStationStatus.washTowel.paramsJSON", "Wash Towel Params JSON", normalized);
        if (typeof normalized !== "object" || normalized === null || Array.isArray(normalized)) {
            return;
        }
        const interval = Number(normalized.interval);
        ...
        const mode = Number(normalized.mode);
    ...
    async refreshWashTowelMode(soakAndWashSupported) {
        try {
            ...
            this.deps.adapter.rLog("System", this.duid, "Warn", this.protocolVersion || undefined, undefined, `Failed to update Wash Towel Mode: ${this.deps.adapter.errorMessage(e)}`, "warn");
        }
    }
    async applyWashTowelModeStatus(rawValue, soakAndWashSupported) {
        const normalized = this.normalizeCommandPayload(rawValue);
        await this.writeJsonState("dockingStationStatus.washTowel.modeJSON", "Wash Towel Mode JSON", normalized);
        if (typeof normalized !== "object" || normalized === null || Array.isArray(normalized)) {
            return;
        }
        const mode = Number(normalized.wash_mode);
        if (!Number.isFinite(mode)) {
            return;
        }
    ...
    async refreshWashTowelTemperature() {
        try {
            const response = await this.deps.adapter.requestsHandler.sendRequest(this.duid, "get_wash_water_temperature", {});
            await this.applyWashTowelTemperatureStatus(response);
        }
        catch (e) {
            this.deps.adapter.rLog("System", this.duid, "Warn", this.protocolVersion || undefined, undefined, `Failed to update Wash Towel Temperature: ${this.deps.adapter.errorMessage(e)}`, "warn");
        }
    }
    async applyWashTowelTemperatureStatus(rawValue) {
        const normalized = this.normalizeCommandPayload(rawValue);
        await this.writeJsonState("dockingStationStatus.washTowel.temperatureJSON", "Wash Towel Temperature JSON", normalized);
        if (typeof normalized !== "object" || normalized === null || Array.isArray(normalized)) {
            return;
        }
        const temperature = Number(normalized.wash_water_temperature);
    ...
    async refreshBinaryResultState(method, params, groupFolder, baseKey, label, responseKey, valueStateKey, valueStateName, enabledStateKey, enabledStateName) {
        try {
            const response = await this.deps.adapter.requestsHandler.sendRequest(this.duid, method, params);
            await this.applyGroupedBinaryResultStatePayload(response, groupFolder, baseKey, label, responseKey, valueStateKey, valueStateName, enabledStateKey, enabledStateName);
        }
        catch (e) {
            this.deps.adapter.rLog("System", this.duid, "Warn", this.protocolVersion || undefined, undefined, `Failed to update ${label}: ${this.deps.adapter.errorMessage(e)}`, "warn");
        }
    }
    async applyGroupedBinaryResultStatePayload(rawValue, groupFolder, baseKey, label, responseKey, valueStateKey, valueStateName, enabledStateKey, enabledStateName) {
        const normalized = this.normalizeCommandPayload(rawValue);
    ...
    deriveBackWashMode(smartWashValue, washIntervalMinutes, backWashNewSmartSupported) {
        if (smartWashValue === 1) {
            return 0;
        }
    ...
    buildSmartWashParams(backWashMode, washIntervalMinutes) {
        return {
            smart_wash: backWashMode === 0 ? 1 : backWashMode === 2 ? 2 : 0,
            wash_interval: washIntervalMinutes * 60
        };
    }
    async assertBackWashModeSupported(backWashMode) {
        if (backWashMode !== 2) {
            return;
        }
        const firmwareFeatures = await this.getZ70FirmwareFeatures();
    ...
    async getZ70FirmwareFeatures() {
        ...
        try {
            ...
            this.deps.adapter.rLog("System", this.duid, "Debug", this.protocolVersion || undefined, undefined, `Failed to fetch Z70 firmware features: ${this.deps.adapter.errorMessage(e)}`, "debug");
            return new Set();
        }
    }
    normalizeFirmwareFeatureIds(rawValue) {
        const normalized = this.normalizeRpcPayload(rawValue);
        if (!Array.isArray(normalized)) {
            return [];
        }
    ...
    readNumericField(rawValue, key) {
        if (typeof rawValue !== "object" || rawValue === null || Array.isArray(rawValue)) {
            return Number.NaN;
        }
        return Number(rawValue[key]);
    }
    async readNumericState(relativePath, fallback) {
        try {
    ...
    getConfiguredCameraPin() {
        const adapterConfig = this.deps.adapter.config;
        if (typeof adapterConfig?.cameraPin !== "string" || !adapterConfig.cameraPin.trim()) {
            return null;
        }
        return adapterConfig.cameraPin.trim();
    }
    getWashTowelModeLabel(mode, soakAndWashSupported) {
        switch (mode) {
            case 0:
    ...
    getWashTemperatureLabel(temperature) {
        switch (temperature) {
            case 0:
                return "Normal";
            case 1:
    ...
    async ensureFolderPath(relativePath) {
    ...
    async applyTidyUpSummaryStatus(rawValue) {
        const normalized = this.normalizeRpcPayload(rawValue);
        ...
        const summaryPayload = normalized;
    ...
    async applyTidyUpZonesStatus(rawValue) {
        const normalized = this.normalizeRpcPayload(rawValue);
    ...
    async updateDerivedCommonStatus(rawCommonStatus) {
    ...
    async updateDerivedDockErrorStatus(rawDockErrorStatus) {
    ...
    async updateDerivedCameraStatus(rawCameraStatus) {
    ...
    async updateDerivedHomeSecStatus(rawHomeSecStatus) {
    ...
    async updateDerivedRobotState(rawState) {
    ...
    async updateDerivedMechanicalArmErrorState(rawErrorCode) {
    ...
    async updateDerivedTaskStatus(prefix, rawTaskStatus) {
    ...
    async updateDerivedBackType(rawBackType) {
        const backType = Number(rawBackType);
        if (!Number.isFinite(backType)) {
            return;
        }
        await super.processResultKey("deviceStatus", "backTypeLabel", Z70_BACK_TYPE_LABELS[backType] ?? `Back Type ${backType}`);
    }
    async updateDerivedWashPhase(rawWashPhase) {
        const washPhase = Number(rawWashPhase);
        if (!Number.isFinite(washPhase)) {
            return;
        }
        await super.processResultKey("deviceStatus", "washPhaseLabel", Z70_WASH_PHASE_LABELS[washPhase] ?? `Wash Phase ${washPhase}`);
    }
    async updateDerivedWashStatus(rawWashStatus) {
    ...
    async updateDerivedWaterShortageStatus(rawWaterShortageStatus) {
    ...
    async refreshDerivedSwitchStatus() {
    ...
    async refreshDerivedRobotControlStates() {
        ...
        const derivedValues = {
            ...
            isTidyUpHouseWork,
            isHomeButtonsEnabled: !isUpdating
                && !isLocked
                && !isLocating
                && !isCollectingDust
                && !isWashing
                ...
                && !isTeardownMop
                && !isDance,
            isHomeModeControlButtonsEnabled: !isUpdating
                && !isLocked
                && !isLocating
                && !isAirDryingStopping
                && !isRemoteMode
                ...
                && !isEggAttack
                && !isTidyUpHouseWork,
            isHomeMapEditButtonsEnabled: !isUpdating
                && !isLocked
                && !isLocating
                && !isAirDryingStopping
                && !isRemoteMode
    ...
    getZ70ObjectTypeLabel(objectType) {
        switch (objectType) {
            case 2:
                return "Shoes";
            case 34:
    ...
    normalizeProgramRuntimeCommands(rawValue) {
        if (!Array.isArray(rawValue)) {
            return [];
        }
        return rawValue.map((command) => this.normalizeProgramRuntimeCommand(command));
    }
    normalizeProgramSummaryEntries(rawValue) {
        if (!Array.isArray(rawValue)) {
            return [];
        }
        return rawValue
    ...
    normalizeProgramDetailEntry(rawValue, summaryEntry) {
    ...
    countProgramBlockNodes(rawValue) {
        if (Array.isArray(rawValue)) {
        ...
        const nestedBlocks = rawValue.blocks;
    ...
    async resolveProgramStartPayload(programId) {
        if (!Number.isFinite(programId)) {
        ...
        const cmdIds = normalized.cmd_ids;
    ...
    normalizeProgramRuntimeCommand(rawValue) {
        if (typeof rawValue !== "object" || rawValue === null || Array.isArray(rawValue)) {
    ...
    getProgramRuntimeCommandText(command, cmdId) {
        if (cmdId === "arm_joints") {
    ...
    getProgramArmMoveCommandText(command) {
    ...
    getProgramArmMoveAxisText(axisIndex, rawValue, step) {
    ...
    readOptionalProgramNumber(value) {
        const numericValue = Number(value);
        return Number.isFinite(numericValue) ? numericValue : 0;
    }
    async refreshDerivedHomeSecPreviewState() {
    ...
    getProgramRuntimeResultLabel(result) {
        switch (result) {
            case -2:
    ...
    getProgramStateLabel(programState) {
        switch (programState) {
            case 0:
    ...
    extractCommonStatusBits(value, shift, mask) {
