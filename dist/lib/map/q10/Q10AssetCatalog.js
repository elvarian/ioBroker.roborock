...
exports.Q10AssetCatalog = void 0;
exports.resolveQ10PluginAssetPath = resolveQ10PluginAssetPath;
const path = __importStar(require("node:path"));
const Q10_PLUGIN_ROOT = path.join(process.cwd(), ".AppPlugins", "Q10 X5+", "019bdf41f583723bb937ccc99bbd7541");
const DRAWABLE_DIR = "drawable-mdpi";
const RAW_DIR = "raw";
function drawable(name) {
    return path.posix.join(DRAWABLE_DIR, name);
}
function drawableList(prefix, count, suffix = ".png") {
    return Array.from({ length: count }, (_, index) => drawable(`${prefix}${index}${suffix}`));
}
function raw(name) {
    return path.posix.join(RAW_DIR, name);
}
function resolveQ10PluginAssetPath(relativePath) {
    return path.join(Q10_PLUGIN_ROOT, ...relativePath.split("/"));
}
exports.Q10AssetCatalog = {
...
//# sourceMappingURL=Q10AssetCatalog.js.map