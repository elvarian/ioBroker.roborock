...
exports.buildQ10Verification = buildQ10Verification;
const VERIFIED_WITH_CURRENT_SAMPLES = new Set([
    "paths",
    "virtualWalls",
    "roomTags",
    "obstacles",
...
const VERIFIED_NOTE = "Seen in the current project Q10 fixture set and checked against the original behavior.";
const UNVERIFIED_NOTE = "Ported source-first from the original code, but not yet seen in the current project Q10 fixture set.";
const FEATURE_COUNT_GETTERS = {
...
function getFeatureCount(mapData, feature) {
    return FEATURE_COUNT_GETTERS[feature](mapData);
}
function buildQ10Verification(mapData) {
...
//# sourceMappingURL=Q10Verification.js.map