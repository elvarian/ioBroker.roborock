...
(0, vitest_1.describe)("Error Resilience", () => {
    ...
    (0, vitest_1.it)("should handle request failures gracefully", async () => {
        ...
        await (0, vitest_1.expect)(vacuumFeatures.updateStatus()).rejects.toThrow("Network Error");
        (0, vitest_1.expect)(warnCalled).to.be.true;
    });
});
