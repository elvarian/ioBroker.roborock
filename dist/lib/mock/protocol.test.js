...
(0, vitest_1.describe)("Protocol Deep Dive (messageParser)", () => {
    let mockAdapter;
    let parser;
    ...
    (0, vitest_1.it)("should reject invalid CRC", () => {
        ...
        (0, vitest_1.expect)(decoded).to.be.an("array").that.is.empty;
    });
    (0, vitest_1.it)("should accept valid CRC", () => {
        ...
        (0, vitest_1.expect)(logError).to.include("Decryption");
        (0, vitest_1.expect)(logError).to.not.include("CRC32 mismatch");
    });
});
