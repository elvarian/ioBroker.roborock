...
exports.PALETTE_DARK_HIGHLIGHT = exports.PALETTE_DARK_NORMAL = exports.PALETTE_LIGHT_HIGHLIGHT = exports.PALETTE_LIGHT_NORMAL = void 0;
exports.getPalette = getPalette;
exports.assignRoborockRoomColorsToHex = assignRoborockRoomColorsToHex;
/**
 ...
 */
exports.PALETTE_LIGHT_HIGHLIGHT = [
    "#DFDFDFff", // 0: Background
 ...
 */
exports.PALETTE_DARK_HIGHLIGHT = [
    "#DFDFDFff", // 0: Background
...
function getPalette(type) {
    switch (type) {
        case "light_normal":
            return exports.PALETTE_LIGHT_NORMAL;
        case "light_highlight":
            return exports.PALETTE_LIGHT_HIGHLIGHT;
        case "dark_normal":
            return exports.PALETTE_DARK_NORMAL;
        case "dark_highlight":
            return exports.PALETTE_DARK_HIGHLIGHT;
        default:
            return exports.PALETTE_DARK_HIGHLIGHT;
    }
}
 ...
 */
function assignRoborockRoomColorsToHex(data, options) {
    ...
    const colorUsed = Array.from({ length: numColors }, () => []);
    if (maxIndex >= idOffset && maxIndex < matrixSize) {
    ...
    for (let i = 0; i < numColors; i++) {
        if (colorUsed[i].length === 0) {
            ...
            if (sourceID < 0 || sourceID >= numColors || colorUsed[sourceID].length <= 1)
                continue;
    ...
    // Helper to get hex
    const getColor = (roomId, paletteType) => {
...
//# sourceMappingURL=roomColoring.js.map